...
class About:
    ...
    def verify_page():
        ...
        Driver().find_element(By.XPATH, About._greeting_xpath)

    @staticmethod
    def check_stats():
        num_stats = []
        online_stats = Driver().find_elements(By.XPATH, About._stats_xpath)
        for st in online_stats:
            stats = Driver().execute_script("return arguments[0].innerText;", st)
